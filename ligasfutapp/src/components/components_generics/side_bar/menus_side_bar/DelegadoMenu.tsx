...
const DelegadoMenu: React.FC<{ isOpen: boolean; isHovered: boolean; menuDisabled: boolean, userType: string }> = ({ isOpen, isHovered, menuDisabled, userType }) => {
    ...
    const menuItems: MenuItem[] = [
        ...
        { text: 'Gestionar', icon: '/images/logos/Icono_Gestionar_Blanco.png', enabled: true, path: process.env.NODE_ENV === 'production' ? `/user/player/manage_team.html?role=${userType}` : `/user/player/manage_team/?role=${userType}`, background: '' },
    ];
