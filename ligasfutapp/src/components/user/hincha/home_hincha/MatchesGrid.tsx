            ...
            <div className="overflow-x-auto overflow-y-auto custom-scrollbar h-auto max-h-[615px]">
                <table className="w-full table-auto">
                    <thead className="bg-[#1e3a8a] text-white h-[60px] sticky top-0 z-10">
                        <tr>
                            <th className="py-3 px-1 sm500:px-10 text-center text-sm sm590:text-base sm670:text-xl font-medium tracking-tight">
                                Fecha
                            </th>
                            <th className="py-3 px-1 sm500:px-10 text-center text-sm sm590:text-base sm670:text-xl font-medium tracking-tight">
                                Hora
                        ...
                        {partidos && partidos.length > 0 ? (
                            partidos.map((partido, index) => (
                                ...
                                >
                                    ...
                                    <td className={`py-4 px-1 sm500:px-10 text-center text-center ${partido.estado === 'Finalizado' ? 'text-green-500' : 'text-orange-500'}`}>
                                        {partido.estado}
                                    </td>
                                    <td className="py-4 px-1 sm500:px-10 text-center flex justify-center">
                                        <CustomButton
                                            text="Detalles"
                                            color="#3b81f5"
                                            width=""
