    ...
    return (
        <>
            ...
            {eventType === EVENT_TYPES.INICIO_DEL_PARTIDO && (
                <div className="text-xs sm590:text-xl text-center text-gray-600 my-2 mb-8">
                    --- Inicio ---
                </div>
            )}
            ...
            {eventType === EVENT_TYPES.SUSTITUCION_SALE && (
                <div className="flex my-2 w-[90%] w-full mb-8">
                    {/* Jugador que sale */}
                    <div className="flex-1 flex justify-end items-center">
                        {team === nombreEquipoLocal && (
                            <span className="text-xs sm590:text-xl text-gray-800 mr-2 max-w-[80%]">
                                {playerOut}
                                {time !== 0 && ` - ${time}’`}
                            </span>
                        )}
                    ...
                    <div className="flex-1 flex justify-start items-center">
                        {team === nombreEquipoVisitante && (
                            <span className="text-xs sm590:text-xl text-gray-800 ml-2 max-w-[80%]">
            ...
            {eventType === EVENT_TYPES.AUTO_GOL && (
                <div className="text-sm sm590:text-xl flex my-2 w-[90%] w-full mb-8">
                    <div className="flex-1 flex justify-end items-center">
                        {team === nombreEquipoLocal && (
                            <span className="text-xs sm590:text-xl text-gray-800 mr-2 max-w-[80%]">
                    ...
                    <div className="w-12 flex justify-center">
                        <Image
                            src="/images/logos/Icono_Balon.png"
                            width={100}
                            height={100}
                            alt="Autogol"
                            className="w-10 h-10"
            ...
            {eventType !== EVENT_TYPES.FIN_DEL_PRIMER_TIEMPO &&
                ...
                eventType !== EVENT_TYPES.INICIO_DEL_PARTIDO && 
                eventType !== EVENT_TYPES.AUTO_GOL && (
                    <div className="flex my-2 w-[90%] mb-8 bg">
                        <div className="flex-1 flex justify-end items-center">
                            {team === nombreEquipoLocal && (
                                <span className="text-xs sm590:text-xl text-gray-800 mr-2 max-w-[80%]">
                                    {player}{time !== 0 && ` - ${time}’`}
