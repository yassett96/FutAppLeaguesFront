...
const Result = ({ localTeam, localGoals, visitorTeam, visitorGoals }) => {
    return (
        <div className="flex flex-col items-center mb-6 text-shadow-lg mr-[9%] w-[100%] sm550:w-[80%]">
            <h2 className="text-4xl font-bold text-black opacity-50 ml-[5%] xs340:ml-[0%] xs360:ml-[0%] xl-1100:ml-[4%]">Resultado</h2>
            <div className="flex flex-row justify-center items-center mt-2 ml-[7%] text-black opacity-50 w-[90%]">
