...
/**
 * Crea un torneo Liga completo en el servidor.
 * @async
 * @function crearTorneoLigaCompleto
 ...
 */
export const crearTorneoLigaCompleto = async (
    torneoData: object
    ...
    try {
        const response = await fetch(`${API_URL}/api/creacionTorneosLiga/creacion-torneo`, {
            method: 'POST',
            headers: {
