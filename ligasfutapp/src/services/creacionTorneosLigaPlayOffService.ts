...
/**
 * Crea un torneo Liga/Play-Off completo en el servidor.
 * @async
 * @function crearTorneoLigaPlayOffCompleto
 ...
 */
export const crearTorneoLigaPlayOffCompleto = async (
    torneoData: object
    ...
    try {
        const response = await fetch(`${API_URL}/api/creacionTorneosLigaPlayOff/creacion-torneo`, {
            method: 'POST',
            headers: {
